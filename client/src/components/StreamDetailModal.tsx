        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <div className="text-2xl font-bold text-gray-900">{formatBytes(state.bytes)}</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-sm text-gray-900">{formatLimit(config.max_msgs)}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-sm text-gray-900">{config.max_bytes === -1 ? 'No limit' : formatBytes(config.max_bytes)}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-sm text-gray-900">{formatAge(config.max_age)}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="mt-1">
                    <span className="text-sm text-gray-900">{formatLimit(config.max_consumers)}</span>
                  </div>
                </div>
              </div>
            </div>
